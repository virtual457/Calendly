...
public class EditCalendarCommand implements ICommand {
  ...
  public EditCalendarCommand(List<String> args, ICalendarModel model,String calendarName) {
    ...
    try {
      // '--name'
      if (index >= args.size()) throw new IllegalArgumentException("Missing '--name' keyword.");
      ...
      // <name-of-calendar>
      if (index >= args.size()) throw new IllegalArgumentException("Missing calendar name.");
      ...
      // '--property'
      if (index >= args.size()) throw new IllegalArgumentException("Missing '--property' keyword.");
      ...
      // <property-name>
      if (index >= args.size()) throw new IllegalArgumentException("Missing property name.");
      ...
      // <new-property-value>
      if (index >= args.size()) throw new IllegalArgumentException("Missing new property value.");
