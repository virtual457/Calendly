...
/**
 * Unit tests for the {@link CopyEventsCommand} class.
 * This class verifies the behavior of the copy events functionality,
 * including correct command parsing, validation, time zone adjustments,
 * and proper delegation to the model.
 */
...
public class CopyEventsCommandTest {
  ...
  private static class MockModel implements ICalendarModel {
    ...
    @Override
    public boolean copyEvents(String sourceCalendar, LocalDateTime rangeStart,
  ...
  public void testCopyEventsBetweenValid() {
    MockModel model = new MockModel();
    CopyEventsCommand command = new CopyEventsCommand(
        Arrays.asList("between", "2025-05-01", "and", "2025-05-03", "--target", "Work", "to",
            "2025-06-01"),
        model,
        "Default"
    );
  ...
  public void testInvalidStartDateBetween() {
    new CopyEventsCommand(
        Arrays.asList("between", "bad", "and", "2025-05-03", "--target", "Work", "to", "2025-06" +
            "-01"),
        new MockModel(),
        "Test"
    );
  ...
  public void testMissingAndKeyword() {
    new CopyEventsCommand(
        Arrays.asList("between", "2025-05-01", "WRONG", "2025-05-03", "--target", "Work", "to",
            "2025-06-01"),
        new MockModel(),
        "Test"
    );
