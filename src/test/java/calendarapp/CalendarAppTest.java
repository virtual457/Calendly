...
public class CalendarAppTest {
  ...
  public void testEditNonRecurringEvent_UpdateLocation_ShouldExportCorrectly() throws IOException {
    ...
    String expected = String.join("\n",
            "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private",
            "\"Meeting\",06/10/2025,10:00 AM,06/10/2025,11:00 AM,False,\"\",\"Room B\",False"
    );
    assertEquals(expected, readExportedFile());
  }

  @Test
  public void testEditNonRecurringEvent_UpdateStart_ShouldExportCorrectly() throws IOException {
    String[] commands = {
            ...
            "edit events start Briefing from 2025-06-20T09:00 with \"2025-06-20T08:45:00\"",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
  ...
  @Test
  public void testEditNonRecurringEvent_UpdateEnd_ShouldExportCorrectly() throws IOException {
    String[] commands = {
  ...
  public void testEditNonRecurringEvent_UpdateDescription_ShouldExportCorrectly() throws IOException {
    String[] commands = {
            ...
            "edit events description Update from 2025-06-20T09:00 with \"Weekly review session\"",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
    String expected = String.join("\n",
            "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private",
            "\"Update\",06/20/2025,09:00 AM,06/20/2025,10:00 AM,False,\"Weekly review session\",\"\",False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  @Test
  public void testEditRecurringEvents_SingleOccurrenceEdit_ShouldUpdateOnlyFirst() throws IOException {
    String[] commands = {
            "create calendar --name RecurrEditNR_Single --timezone America/New_York",
            "use calendar --name RecurrEditNR_Single",
            "create event Standup from 2025-07-07T09:00 to 2025-07-07T09:30 repeats M for 2 times",
  ...
  public void testEditRecurringEvents_UpdateAllOccurrences_ShouldUpdateAll() throws IOException {
    String[] commands = {
            ...
            "create event Standup from 2025-04-24T09:00 to 2025-04-24T10:00 repeats R for 3 times",
    ...
    String expected = String.join("\n",
            ...
            "\"Standup\",05/01/2025,09:00 AM,05/01/2025,10:00 AM,False,\"\",\"Room C\",False",
            "\"Standup\",05/08/2025,09:00 AM,05/08/2025,10:00 AM,False,\"\",\"Room C\",False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  public void testEditRecurringEvents_UpdateStartTime_ShouldUpdateAll() throws IOException {
    String[] commands = {
            ...
            // Update start time for all occurrences to 08:45 (shift by 15 minutes earlier).
  ...
  // Test: Edit event with an empty new value (e.g. setting description to an empty string).
  @Test
  ...
  public void testEditRecurringEvents_InvalidDatetimeFormat_ShouldFail() {
    String[] commands = {
            ...
            "create event Standup from 2025-04-24T09:00 to 2025-04-24T09:30 repeats T for 3 times",
            "edit events start Standup from 2025-04-24T09:00 with \"2025/04/24 09:15:00\"",
            "exit"
    };
    runAppWithCommands(commands);
    assertTrue(outContent.toString().toLowerCase().contains("could not be parsed"));
  ...
  // Test: Edit non‐recurring event – updating property "start" with an invalid datetime string.
  @Test
  ...
  // Test: Edit non‐recurring event – updating property "end" with an invalid datetime string.
  @Test
  ...
  public void testEditEvents_NullFromDateTime_ShouldFail() throws IOException {
    // In our command-driven parser, a null value would likely be represented as the literal "null".
    String[] commands = {
    ...
    assertTrue(outContent.toString().contains("Text 'null' could not be parsed at index 0"));
    assertEquals(expected, readExportedFile());
  }

  // Test: Edit events with a numeric value for a boolean property (ispublic) that does not parse.
  @Test
  ...
  // Test: Edit events where property is an empty string (i.e. missing property keyword) should fail.
  @Test
  ...
  @Test
  public void testEditEvents_MixedEvents_UpdateOnlyLaterOccurrence_ShouldUpdateOnlyMatching() throws IOException {
    String[] commands = {
            "create calendar --name MixedCal --timezone America/New_York",
            "use calendar --name MixedCal",
            "create event Team from 2025-08-01T09:00 to 2025-08-01T10:00",    // Earlier event
            "create event Team from 2025-08-01T11:00 to 2025-08-01T12:00",    // Later event
  ...
  @Test
  public void testEditEvents_MultipleOccurrences_EditAllTrue_ShouldUpdateAll() throws IOException {
    String[] commands = {
            "create calendar --name RecurrEditAllExtra --timezone America/New_York",
            "use calendar --name RecurrEditAllExtra",
            // Create a recurring event "Standup" that recurs on Thursdays for 3 occurrences.
            "create event Standup from 2025-04-24T09:00 to 2025-04-24T10:00 repeats R for 3 times",
  ...
  // Create two non-recurring events with the same name, then update description only for those with start time >= given boundary.
  @Test
  public void testEditEvents_UpdateDescriptionForLaterEvents_ShouldUpdateOnlyMatching() throws IOException {
    String[] commands = {
            "create calendar --name DescUpdateCal --timezone America/New_York",
            "use calendar --name DescUpdateCal",
            "create event Briefing from 2025-08-15T09:00 to 2025-08-15T10:00",   // Event 1
            "create event Briefing from 2025-08-15T11:00 to 2025-08-15T12:00",   // Event 2
            // Update description for events starting at or after 10:30.
            "edit events description Briefing from 2025-08-15T10:30 with \"Updated session\"",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
    ...
    String expected = String.join("\n",
            ...
            "\"Briefing\",08/15/2025,11:00 AM,08/15/2025,12:00 PM,False,\"Updated session\",\"\",False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  public void testEditEvents_SequentialPropertyUpdates_ShouldExportCorrectly() throws IOException {
    String[] commands = {
            ...
            "edit events description Update from 2025-08-20T10:00 with \"Quarterly review\"",
    ...
    String expected = String.join("\n",
            "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private",
            "\"ReviewMeeting\",08/20/2025,10:00 AM,08/20/2025,11:00 AM,False,\"Quarterly review\",\"Room 101\",False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  public void testEditEvents_NoChangeInNewValue_ShouldSucceed() throws IOException {
    String[] commands = {
            ...
            "create event Briefing from 2025-08-30T10:00 to 2025-08-30T11:00 --description \"Initial\"",
    ...
    String expected = String.join("\n",
            "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private",
            "\"Briefing\",08/30/2025,10:00 AM,08/30/2025,11:00 AM,False,\"Initial\",\"\",False"
    );
    assertEquals(expected, readExportedFile());
  }

  @Test
  public void testEditEvents_UpdateDescriptionWithWhitespace_ShouldExportCorrectly() throws IOException {
    String[] commands = {
            "create calendar --name WhiteSpaceNR --timezone America/New_York",
            "use calendar --name WhiteSpaceNR",
            "create event Planning from 2025-07-10T09:00 to 2025-07-10T10:00 --description \"Initial Plan\"",
            "edit events description Planning from 2025-07-10T09:00 with \"  Revised Plan  \"",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
    ...
    String expected = String.join("\n",
            "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private",
            "\"Planning\",07/10/2025,09:00 AM,07/10/2025,10:00 AM,False,\"  Revised Plan  \",\"\",False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  public void testEditEvents_EditDescription_ShouldUpdateCorrectly() throws IOException {
    ...
    String expected = String.join("\n",
            "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private",
            "\"Lunch\",07/15/2025,12:00 PM,07/15/2025,01:00 PM,False,\"Team lunch\",\"\",False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  public void testEditEvents_EditEndTime_ShouldFailForInvalidEnd() {
    ...
    runAppWithCommands(commands);
    assertTrue(outContent.toString().toLowerCase().contains("new end must be after current start"));
  }
  ...
  public void testEditEvents_DescriptionUpdate_ShouldPass() throws IOException {
    String[] commands = {
            ...
            "create event Workshop from 2025-07-20T14:00 to 2025-07-20T16:00",
            "edit events description Workshop from 2025-07-20T14:00 with \"Updated workshop description\"",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
    String expected = String.join("\n",
            "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private",
            "\"Workshop\",07/20/2025,02:00 PM,07/20/2025,04:00 PM,False,\"Updated workshop description\",\"\",False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  public void testEditEvents_InvalidDatetime_ShouldFail() {
    String[] commands = {
            ...
            "edit events start Review from 2025-11-15T10:00 with \"2025-11-15 09:30\"", // invalid format
            "exit"
    };
    runAppWithCommands(commands);
    assertTrue(outContent.toString().toLowerCase().contains("could not be parsed"));
  ...
  public void testEditEvent_UpdatePrivateFlag_ShouldSucceed() throws IOException {
    ...
    String expected = String.join("\n",
            "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private",
            "\"Confidential\",09/01/2025,09:00 AM,09/01/2025,10:00 AM,False,\"\",\"\",False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  public void testEditEvents_UpdateLocationForRecurringEvent_EditAll() throws IOException {
    String[] commands = {
            ...
            "create event YogaClass from 2025-07-01T07:00 to 2025-07-01T08:00 repeats T for 2 times",
    ...
    String expected = String.join("\n",
            "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private",
            "\"YogaClass\",07/01/2025,07:00 AM,07/01/2025,08:00 AM,False,\"\",\"Gym Hall\",False",
            "\"YogaClass\",07/08/2025,07:00 AM,07/08/2025,08:00 AM,False,\"\",\"Gym Hall\",False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  // Test: Edit recurring event so that only occurrences starting at or after a specified time are updated.
  @Test
  public void testEditRecurringEvent_PartialOccurrenceUpdate_ShouldUpdateOnlyLaterOccurrences() throws IOException {
    String[] commands = {
            "create calendar --name RecurrPartialCal --timezone America/New_York",
            "use calendar --name RecurrPartialCal",
            // Create a recurring event "Standup" with 3 occurrences (assume weekly recurrence).
            "create event Standup from 2025-07-07T09:00 to 2025-07-07T09:30 repeats M for 3 times",
    ...
    String expected = String.join("\n",
            ...
            "\"Standup\",07/14/2025,09:00 AM,07/14/2025,09:30 AM,False,\"\",\"Room Y\",False",
            "\"Standup\",07/21/2025,09:00 AM,07/21/2025,09:30 AM,False,\"\",\"Room Y\",False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  @Test
  public void testEditRecurringEvent_UpdateDescriptionForLastOccurrence_ShouldUpdateOnlyLast() throws IOException {
    String[] commands = {
            ...
            "create event Briefing from 2025-08-04T09:00 to 2025-08-04T09:30 repeats W for 3 times",
            // Use a fromDateTime equal to the start time of the third occurrence.
            "edit events description Briefing from 2025-08-20T09:00 with \"Final Briefing\"",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
    ...
    String expected = String.join("\n",
            ...
            "\"Briefing\",08/20/2025,09:00 AM,08/20/2025,09:30 AM,False,\"Final Briefing\",\"\",False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  @Test
  public void testEditRecurringEvent_UpdateIsPublic_ShouldUpdateAllOccurrences() throws IOException {
    String[] commands = {
  ...
  // Test: Edit recurring event – update start time for all occurrences, ensuring no conflict.
  @Test
  public void testEditRecurringEvent_UpdateStartTimeAllOccurrences_ShouldUpdateAll() throws IOException {
    String[] commands = {
            "create calendar --name RecurrStartUpdateCal --timezone America/New_York",
            "use calendar --name RecurrStartUpdateCal",
            "create event Standup from 2025-09-01T09:00 to 2025-09-01T09:30 repeats W for 3 times",
            // Update start time for all occurrences: shift by 15 minutes earlier.
            "edit events start Standup from 2025-09-01T09:00 with \"2025-09-01T08:45:00\"",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
  ...
  @Test
  public void testEditRecurringEvent_UpdateEndTimeAllOccurrences_ShouldUpdateAll() throws IOException {
    String[] commands = {
            "create calendar --name RecurrEndUpdateCal --timezone America/New_York",
            "use calendar --name RecurrEndUpdateCal",
            "create event Standup from 2025-09-01T09:00 to 2025-09-01T09:30 repeats M for 3 times",
  ...
  // Test: Edit recurring events – attempt update that would cause a conflict among occurrences.
  @Test
  public void testEditRecurringEvent_UpdateStartTimeConflict_ShouldFail() throws IOException {
    String[] commands = {
            ...
            "create event Standup from 2025-09-01T09:00 to 2025-09-01T09:30 repeats M for 2 times",
            // Attempt to update start time of the first occurrence causing overlap (conflict).
            "edit events start Standup from 2025-09-01T08:45 with \"2025-09-01T08:45:00\"",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
  ...
  public void testEditEvent_UpdateStart_ShouldExportCorrectly() throws IOException {
    String[] commands = {
            ...
            "edit event start Briefing from 2025-06-15T14:00 to 2025-06-15T15:00 with \"2025-06-15T13:45:00\"",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
  ...
  public void testEditEvent_UpdateIsPublic_ShouldExportCorrectly() throws IOException {
    String[] commands = {
            ...
            "edit event isprivate Conference from 2025-06-30T09:00 to 2025-06-30T10:00 with \"false\"",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
  ...
  // Test: Conflict detection for singular editEvent – update start time that causes conflict.
  @Test
  public void testEditEvent_Conflict_ShouldFail() {
    String[] commands = {
            ...
            "edit event start Beta from 2025-07-15T10:00 to 2025-07-15T11:00 with \"2025-07-15T09:30:00\"",
            "exit"
    };
    runAppWithCommands(commands);
    assertTrue(outContent.toString().toLowerCase().contains("conflict detected"));
  ...
  public void testEditEvent_InvalidDatetimeFormat_ShouldFail() {
    String[] commands = {
            ...
            "edit event start Demo from 2025-07-20T09:00 to 2025-07-20T10:00 with \"2025/07/20 09:30:00\"",
            "exit"
    };
    runAppWithCommands(commands);
    assertTrue(outContent.toString().toLowerCase().contains("could not be parsed"));
  ...
  // Test: Updating an event with the same value should succeed (i.e. no change, but export remains unchanged).
  @Test
  public void testEditEvent_UpdateWithSameValue_ShouldExportCorrectly() throws IOException {
    String[] commands = {
            ...
            "create event Update from 2025-09-20T10:00 to 2025-09-20T11:00 --description \"Original\"",
            "edit event description Update from 2025-09-20T10:00 to 2025-09-20T11:00 with \"Original\"",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
    String expected = String.join("\n",
            "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private",
            "\"Update\",09/20/2025,10:00 AM,09/20/2025,11:00 AM,False,\"Original\",\"\",False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  @Test
  public void testEditEvent_UpdateLocationWithSpecialCharacters_ShouldExportCorrectly() throws IOException {
    String[] commands = {
            ...
            "edit event location Meeting from 2025-08-10T14:00 to 2025-08-10T15:00 with \"Room #42 @ HQ\"",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
    String expected = String.join("\n",
            "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private",
            "\"Meeting\",08/10/2025,02:00 PM,08/10/2025,03:00 PM,False,\"\",\"Room #42 @ HQ\",False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  public void testEditEvent_SequentialEdits_ShouldExportCorrectly() throws IOException {
    String[] commands = {
            ...
            "create event Update from 2025-09-20T10:00 to 2025-09-20T11:00 --description \"Initial\"",
            // First update description.
            "edit event description Update from 2025-09-20T10:00 to 2025-09-20T11:00 with \"NewDesc\"",
            // Then update location.
            "edit event location Update from 2025-09-20T10:00 to 2025-09-20T11:00 with \"Room 202\"",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
    String expected = String.join("\n",
            "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private",
            "\"Update\",09/20/2025,10:00 AM,09/20/2025,11:00 AM,False,\"NewDesc\",\"Room 202\",False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  @Test
  public void testEditEvent_UpdateIsPublic_WithUpperCase_ShouldExportCorrectly() throws IOException {
    String[] commands = {
            ...
            "edit event ispublic Meeting from 2025-09-10T09:00 to 2025-09-10T10:00 with \"TRUE\"",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
  ...
  public void testEditEvent_UpdateLocationToEmpty_ShouldExportCorrectly() throws IOException {
    String[] commands = {
            "create calendar --name EmptyLocCal --timezone America/New_York",
            "use calendar --name EmptyLocCal",
            "create event Gathering from 2025-09-11T12:00 to 2025-09-11T13:00 --location \"Office\"",
            "edit event location Gathering from 2025-09-11T12:00 to 2025-09-11T13:00 with \"\"",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
  ...
  public void testEditEvent_UpdateStartWithSameValue_ShouldExportCorrectly() throws IOException {
    String[] commands = {
            ...
            "edit event start Briefing from 2025-09-12T09:00 to 2025-09-12T10:00 with \"2025-09-12T09:00:00\"",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
  ...
  public void testEditEvent_UpdateEndWithSameValue_ShouldExportCorrectly() throws IOException {
    String[] commands = {
            ...
            "edit event end Discussion from 2025-09-13T14:00 to 2025-09-13T15:00 with \"2025-09-13T15:00:00\"",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
  ...
  public void testEditEvent_UpdateName_WithSpaces_ShouldExportCorrectly() throws IOException {
    String[] commands = {
            ...
            "edit event name Update from 2025-09-14T10:00 to 2025-09-14T11:00 with \"  New Name  \"",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
    String expected = String.join("\n",
            "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private",
            "\"  New Name  \",09/14/2025,10:00 AM,09/14/2025,11:00 AM,False,\"\",\"\",False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  public void testEditEvent_Description_Success() throws IOException {
    String[] commands = {
            ...
            "edit event description Review from 2025-05-15T14:00 to 2025-05-15T15:00 with \"Project review meeting\"",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
    String expected = String.join("\n",
            "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private",
            "\"Review\",05/15/2025,02:00 PM,05/15/2025,03:00 PM,False,\"Project review meeting\",\"\",False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  public void testEditEvent_StartTimeAfterEnd_ShouldFail() throws IOException {
    String[] commands = {
            ...
            "edit event start Discussion from 2025-06-20T10:00 to 2025-06-20T11:00 with \"2025-06-20T12:00\"",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
  ...
  public void testEditEvent_Location_Success() throws IOException {
    String[] commands = {
            ...
            "edit event location Briefing from 2025-07-10T09:00 to 2025-07-10T10:00 with \"Main Auditorium\"",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
    String expected = String.join("\n",
            "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private",
            "\"Briefing\",07/10/2025,09:00 AM,07/10/2025,10:00 AM,False,\"\",\"Main Auditorium\",False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  public void testCopyEvents_CommandBased_Success() throws IOException {
    String[] commands = {
            ...
            "copy events from 2025-09-15T00:00 to 2025-09-15T23:59 to calendar TargetCal starting 2025-09-16",
  ...
  public void testCopyEvents_Conflict_ShouldFail() throws IOException {
    String[] commands = {
            ...
            "copy events from 2025-10-01T00:00 to 2025-10-01T23:59 to calendar TargetCal starting 2025-11-01",
            "exit"
    };
    runAppWithCommands(commands);
  ...
  public void testCopyEvents_SimpleCommand() throws IOException {
    String[] commands = {
            ...
            "copy events from FallCal from 2025-09-10T00:00 to 2025-09-10T23:59 to SpringCal starting at 2026-01-10",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
  ...
  public void testCopyEvents_CommandWithNoEvents_ShouldNotCopy() throws IOException {
    String[] commands = {
            ...
            "copy events from Cal1 from 2025-01-01T00:00 to 2025-01-01T23:59 to Cal2 starting at 2025-02-01",
            "use calendar --name Cal2",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
  ...
  public void testCopyEvents_CommandWithConflict_ShouldThrow() throws IOException {
    String[] commands = {
            ...
            "copy events from Original from 2025-09-01T00:00 to 2025-09-01T23:59 to Target starting at 2025-10-01",
            "exit"
    };
    runAppWithCommands(commands);
  ...
  public void testCopyEvents_SingleEvent_SameCalendar() throws IOException {
    String[] commands = {
            ...
            "copy events from 2025-01-01T09:00 to 2025-01-01T10:00 into Cal1 starting 2025-01-01",
  ...
  public void testCopyEvents_SingleEvent_DifferentDate() throws IOException {
    String[] commands = {
            ...
            "copy events from 2025-01-02T09:00 to 2025-01-02T10:00 into Cal2 starting 2025-01-04",
  ...
  public void testCopyEvents_AcrossCalendars() throws IOException {
    String[] commands = {
            ...
            "copy events from 2025-01-03T09:00 to 2025-01-03T10:00 into TargetCal starting 2025-01-05",
            "use calendar --name TargetCal",
  ...
  public void testCopyEvents_NoMatchingEvents_ShouldNotCopy() throws IOException {
    String[] commands = {
            ...
            "use calendar --name Target",
            "copy events from Source between 2025-01-02T00:00 and 2025-01-03T00:00 to 2025-02-01",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
  ...
  public void testCopyEvents_TimezoneAdjustedCorrectly() throws IOException {
    String[] commands = {
            ...
            "use calendar --name Target",
            "copy events from Source between 2025-03-01T00:00 and 2025-03-01T23:59 to 2025-03-02",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
  ...
  public void testCopyEvents_ConflictPreventsCopy() throws IOException {
    String[] commands = {
            ...
            "copy events from Source between 2025-04-10T00:00 and 2025-04-10T23:59 to 2025-05-01",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
  ...
  public void testCopyEvents_EmptyCalendar_NoCopy() throws IOException {
    String[] commands = {
            ...
            "copy events from 2025-01-01T00:00 to 2025-01-02T00:00 into Destination starting 2025-01-05",
  ...
  public void testCopyEvents_RecurringEvent_Copied() throws IOException {
    String[] commands = {
            ...
            "create event Recurring from 2025-03-03T09:00 to 2025-03-03T10:00 --recurring --count 2 --days MONDAY",
            "copy events from 2025-03-02T00:00 to 2025-03-10T23:59 into MirrorCal starting 2025-04-07",
  ...
  public void testCopyEvents_Conflict_ThrowsError() throws IOException {
    String[] commands = {
            ...
            "copy events from 2025-06-10T09:00 to 2025-06-10T10:00 into Target starting 2025-07-01",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
  ...
  public void testCopyEvents_InvalidDateRange_ShouldFail() throws IOException {
    String[] commands = {
            ...
            "copy events from 2025-05-02T00:00 to 2025-05-01T00:00 into B starting 2025-05-10",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
  ...
  public void testCopyEvents_AcrossTimezones_WithExpectedExport() throws IOException {
    String[] commands = {
            ...
            "copy events from NYCal between 2025-04-01T08:00 and 2025-04-01T11:00 to TokyoCal starting 2025-04-02",
  ...
  public void testCopyEvents_NoEventsInRange_ShouldNotCopy() throws IOException {
    String[] commands = {
            ...
            "copy events from A between 2025-02-01T08:00 and 2025-02-01T09:00 to B starting 2025-02-02",
            "use calendar --name B",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
  ...
  public void testCopyEvents_MultipleSpacedEvents() throws IOException {
    String[] commands = {
            ...
            "copy events from SpringCal between 2025-03-01T00:00 and 2025-03-04T00:00 to FallCal starting 2025-09-01",
            "use calendar --name FallCal",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
  ...
  public void testCopyEvents_LAtoTokyo_TimeShift() throws IOException {
    String[] commands = {
            ...
            "copy events from LA between 2025-05-10T00:00 and 2025-05-10T23:59 to Tokyo starting 2025-05-11",
    ...
    String expected = String.join("\n",
            "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private",
            "\"DesignReview\",05/11/2025,10:00 AM,05/11/2025,11:00 AM,False,\"\",\"\",False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  public void testCopyEvents_UTCtoIST_AdjustTime() throws IOException {
    String[] commands = {
            ...
            "copy events from Global between 2025-08-01T00:00 and 2025-08-01T23:59 to India starting 2025-08-02",
  ...
  public void testCopyEvents_DST_NewYorkToLondon() throws IOException {
    String[] commands = {
            ...
            "copy events from NY between 2025-03-09T00:00 and 2025-03-09T23:59 to London starting 2025-03-10",
  ...
  public void testCopyEvents_KathmanduToChicago_HalfHourZone() throws IOException {
    String[] commands = {
            ...
            "copy events from KTM between 2025-07-15T00:00 and 2025-07-15T23:59 to Chicago starting 2025-07-16",
    ...
    String expected = String.join("\n",
            "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private",
            "\"HalfHourTest\",07/16/2025,09:00 AM,07/16/2025,10:00 AM,False,\"\",\"\",False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  public void testCopyEvents_SameCalendarName() throws IOException {
    String[] commands = {
            ...
            "copy events from MyCal between 2025-06-10T00:00 and 2025-06-10T23:59 to MyCal starting 2025-06-17",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
    runAppWithCommands(commands);
  ...
  public void testCopyEvents_MultipleEventsOneConflictsNoneCopied() throws IOException {
    String[] commands = {
            ...
            "use calendar --name TargetCal",
            "create event Conflict from 2025-11-01T11:00 to 2025-11-01T12:00", // Will conflict with Event2

            // Now attempt to copy both events into TargetCal
            "copy events from SourceCal between 2025-10-01T08:00 and 2025-10-01T12:00 to TargetCal starting 2025-11-01",
    ...
    String output = outContent.toString().toLowerCase();
    assertTrue(output.contains("conflict detected")); // Confirm the error message was shown
  ...
  public void testCopySingleEvent_WithConflict_ShouldFail() throws IOException {
    String[] commands = {
            ...
            "use calendar --name TargetCal",
            "create event Blocker from 2025-09-01T09:00 to 2025-09-01T09:30", // This will conflict with copied event

            // Attempt to copy the conflicting event
            "copy events from SourceCal between 2025-08-01T08:00 and 2025-08-01T10:00 to TargetCal starting 2025-09-01",
  ...
  public void testCopyEvent_EventNotFound_ShouldFail() throws IOException {
    String[] commands = {
            "create calendar --name SourceCal --timezone America/New_York",
            "create calendar --name TargetCal --timezone America/New_York",
            "copy event GhostEvent from 2025-08-01T09:00 to TargetCal at 2025-09-01T09:00",
            "exit"
    };
  ...
  public void testCopyEvent_AcrossTimezones_ShiftedCorrectly() throws IOException {
    String[] commands = {
            ...
            "copy event TeamCall from 2025-09-01T09:00 to ISTCal at 2025-09-02T18:30", // 9 AM EDT ≈ 6:30 PM IST
  ...
  public void testCopyEvent_ConflictInTarget_ShouldFail() throws IOException {
    String[] commands = {
            ...
            "copy event OverlapMe from 2025-07-01T10:00 to B at 2025-07-02T10:00", // Conflict with Blocker
            "exit"
    };
  ...
  public void testCopyEvent_InvalidTimeFormat_ShouldFail() throws IOException {
    String[] commands = {
            ...
            "copy event BadTime from 2025-10-01 12:00 to Y at 2025-10-02T12:00", // Invalid source datetime
            "exit"
    };
  ...
  public void testCopyEvent_WithMetadata() throws IOException {
    String[] commands = {
            ...
            "create event Workshop from 2025-11-05T15:00 to 2025-11-05T16:00 desc \"Hands-on\" loc \"Lab 42\"",
    ...
    String expected = String.join("\n",
            "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private",
            "\"Workshop\",11/05/2025,03:00 PM,11/05/2025,04:00 PM,False,\"Hands-on\",\"Lab 42\",False",
            "\"Workshop\",11/06/2025,03:00 PM,11/06/2025,04:00 PM,False,\"Hands-on\",\"Lab 42\",False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  public void testCopyEvent_SameCalendar_DifferentTime() throws IOException {
    String[] commands = {
            ...
            "copy event DailyStandup from 2025-09-01T10:00 to SoloCal at 2025-09-02T10:00",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
  ...
  public void testCopyEvent_PrivateEvent() throws IOException {
    String[] commands = {
            ...
            "create event StrategySession from 2025-10-10T14:00 to 2025-10-10T15:00 private",
            "copy event StrategySession from 2025-10-10T14:00 to SecureCal at 2025-10-17T14:00",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
  ...
  public void testCopyEvent_NullCalendar_ShouldFail() throws IOException {
    String[] commands = {
            ...
            "copy event Keynote from 2025-10-01T09:00 to  at 2025-10-05T09:00", // Missing target calendar
            "exit"
    };
  ...
  public void testCopyEvent_ZeroDuration() throws IOException {
    ...
    String expected = String.join("\n",
            "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private",
            "\"InstantEvent\",10/10/2025,11:00 AM,10/10/2025,11:00 AM,False,\"\",\"\",False",
            "\"InstantEvent\",10/11/2025,11:00 AM,10/11/2025,11:00 AM,False,\"\",\"\",False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  public void testCopyEvent_AutoDecline_NoConflict() throws IOException {
    String[] commands = {
            ...
            "create event SecureMeeting from 2025-10-20T09:00 to 2025-10-20T10:00 autodecline",
            "copy event SecureMeeting from 2025-10-20T09:00 to AutoCal at 2025-10-21T09:00",
            "export cal " + OUTPUT_FILE,
            "exit"
    };
  ...
  public void testCopyEvent_ChicagoToKathmandu() throws IOException {
    ...
    String expected = String.join("\n",
            "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description,Location,Private",
            "\"LocalMeeting\",07/01/2025,05:45 PM,07/01/2025,06:45 PM,False,\"\",\"\",False"
    );
    assertEquals(expected, readExportedFile());
  }
