...
public class CalendarAppTest {
  ...
  public void testPrintEvents_RangeWithinEventDuration_ShouldInclude() throws IOException {
    String[] commands = {
          ...
          "create event Block from 2024-07-09T09:00 to 2024-07-09T11:00 --location " +
                "Studio",
  ...
  public void testEditEvents_NullCalendarName_ShouldFail() {
    ...
    runAppWithCommands(commands);
    assertTrue(outContent.toString().contains("Error Executing command: Please use " +
          "somme calendar"));
  }
  ...
  public void testCopyEvents_RecurringEvent_Copied() throws IOException {
    String[] commands = {
          ...
          "create event Recurring from 2025-03-03T09:00 to 2025-03-03T10:00 repeats M" +
                " for 2 times",
          "copy events between 2025-03-03 and 2025-03-10 --target MirrorCal to " +
                "2025-04-07",
  ...
  public void testCopyEvents_LAtoTokyo_TimeShift() throws IOException {
    String[] commands = {
          ...
          "copy events on 2025-05-10 --target Tokyo to 2025-05-11",
    ...
    String expected = String.join("\n",
          "Subject,Start Date,Start Time,End Date,End Time,All Day Event,Description," +
                "Location,Private",
          "\"DesignReview\",05/12/2025,02:00 AM,05/12/2025,03:00 AM,False,\"\",\"\"," +
                "False"
    );
    assertEquals(expected, readExportedFile());
  }
  ...
  public void testCopyEvents_MultipleEventsOneConflictsNoneCopied() throws IOException {
    String[] commands = {
          ...
          "use calendar --name SourceCal",
          "copy events between 2025-10-01 and 2025-10-01 --target TargetCal to " +
                "2025-11-01",
  ...
  public void testCopyEvent_EventNotFound_ShouldFail() throws IOException {
    String[] commands = {
          ...
          "create calendar --name TargetCal --timezone America/New_York",
          "use calendar --name SourceCal",
          "copy event GhostEvent on 2025-08-01T09:00 --target TargetCal to " +
                "2025-09-01T09:00",
          "exit"
    };
    ...
    assertTrue(output.contains("Error Executing command: Event with name 'GhostEvent' " +
          "on 2025-08-01T09:00 not found in calendar SourceCal"));
  }
  ...
  public void testCopyEvent_MissingSourceCalendar_ShouldFail() throws IOException {
    String[] commands = {
          "create calendar --name Target --timezone America/New_York",
          // Not using or creating a source calendar before attempting to copy
          "copy event Nonexistent on 2025-08-01T09:00 --target Target to " +
                "2025-08-02T09:00",
          "exit"
    };
    runAppWithCommands(commands);
